 ...
 * @author epetruk
 *
 *         Represents the file the user loads. Holds all words found in file and
 *         separately holds start indexes of each word found.
 */
public class FileToSpellCheck extends SpellCheckFile {
	 ...
	 * @return
	 * 
	 * 		save the index of words. ALso save all words found in order;
	 *         order is important for displaying words as they appear in the
	 *         file to the user.
	 * 
	 */
	public int storeWordsForSpellChecking() {
		try {
			...
			// not the best pattern but sufficient if one is only looking for
